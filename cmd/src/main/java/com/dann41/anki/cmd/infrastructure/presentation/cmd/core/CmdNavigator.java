...
import com.dann41.anki.cmd.infrastructure.presentation.cmd.authentication.AuthenticationContract;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.authentication.AuthenticationView;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.collectionimport.CollectionImportContract;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.collectionimport.CollectionImportView;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.deckplayer.DeckPlayerContract;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.deckplayer.DeckPlayerView;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.deckselection.DeckSelectionContract;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.deckselection.DeckSelectionView;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.login.LoginContract;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.login.LoginView;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.deckcreation.DeckCreationView;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.deckcreation.DeckCreationScreen;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.signup.SignUpContract;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.signup.SignUpView;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.usermenu.UserMenuContract;
import com.dann41.anki.cmd.infrastructure.presentation.cmd.usermenu.UserMenuView;
